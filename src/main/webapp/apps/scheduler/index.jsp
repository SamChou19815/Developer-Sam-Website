    ...
    var Controller = {
        addItem: function () {
            ...
            $.post("add", {
                ...
                if (data === "true") {
                    alert("You have successfully added a new scheduler item. " +
                        "The page is going to be reloaded.");
                    location.reload();
                } else {
                    alert("You have not given the description OR " +
                        "the date you've given is illegal.");
                }
            })
        },
        deleteItem: function (key) {
            $.get("delete", {key: key}, function () {
                alert("You have successfully deleted the scheduler item. " +
                    "The page is going to be reloaded.");
                location.reload();
            })
        },
        changeCompletionStatusOfAnItem: function (key, completed) {
            $.get("changeCompletionStatus", {
                ...
                alert("You have successfully changed the completion status " +
                    "of the scheduler item. The page is going to be reloaded.");
                location.reload();
            })
        }
    }
