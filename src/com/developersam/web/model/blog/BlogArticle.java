...
/**
 * Blog article object.
 * It serves both to add a blog article and retrieve info to be used by custom tags.
 */
public class BlogArticle extends DataStoreObject {
     ...
     */
    private void constructBlogArticleInViewMode() throws BlogArticleNotFoundException {
     ...
     * @return not the form url, but only the necessary segment that helps to locate it.
     */
     ...
     */
    public void addComment(UserService userService, boolean anonymous, String content)
     ...
     * @throws BlogCommentActionPermissionDenied the user has not signed in or does not send the comment
     */
