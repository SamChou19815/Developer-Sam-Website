...
public class BlogArticles extends DataStoreObject {
    ...
    /**
     * Initialize the object by stating it relates to BlogArticle entity in
     * DataStore.
     */
    public BlogArticles() {
        super("BlogArticle");
    ...
    public List<BlogArticle> getArticles() {
        ...
        Query q = getQuery().addSort("published", DESCENDING);
    ...
    /**
     * Increase an IP address's visiting frequency by 1 for the main page of
     * blog article.
     *
     * @param ip ip address.
     */
