...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    ...
    <main class="mdl-layout__content">
        <t:Card title="DevSALON">
            ...
            <t:CardActions>
                <t:LinkButton href="https://devsalon.github.io/"
                              openInNewTab="true">View on GitHub</t:LinkButton>
            </t:CardActions>
        </t:Card>
        <t:Card title="SAM">
            <t:CardText>An online platform for homework assignment.</t:CardText>
            <t:CardActions>
                <t:LinkButton href="https://github.com/SamChou19815/SAM"
                              openInNewTab="true">
                    Project on GitHub
                </t:LinkButton>
            </t:CardActions>
        ...
        <t:Card title="Matrix (not available)">
            ...
            <t:CardActions>
                <t:LinkButton
                        href="resource/papers/EvolutionandAssimilation.pdf"
                        openInNewTab="true">
                    Latest Paper
                </t:LinkButton>
            </t:CardActions>
        ...
        <t:Card title="Small Projects">
            <t:CardText>
                Some of the small programming projects I developed
                and open-sourced.
            </t:CardText>
            <t:CardActions>
                <t:LinkButton href="https://github.com/SamChou19815/Snake-Game"
                              openInNewTab="true">
                    Snake
                </t:LinkButton>
                <t:LinkButton
                        href="https://github.com/SamChou19815/TEN-Board-Game"
                        openInNewTab="true">
                    TEN
                </t:LinkButton>
            </t:CardActions>
